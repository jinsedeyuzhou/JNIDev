...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_ebrightmoon_jni_crypto_JNITool_desencrypt(JNIEnv *env, jclass type, jbyteArray jbArr) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_ebrightmoon_jni_crypto_JNITool_desdecrypt(JNIEnv *env, jclass type, jstring out_str) {
...
extern "C"
JNIEXPORT jstring JNICALL
Java_com_ebrightmoon_jni_crypto_JNITool_rsaencrypt(JNIEnv *env, jclass type, jbyteArray jbArr) {
...
extern "C"
JNIEXPORT jbyteArray JNICALL
Java_com_ebrightmoon_jni_crypto_JNITool_rsadecrypt(JNIEnv *env, jclass type, jstring out_str) {
